...
В прошивке используется 3 endpoint'а, это как бы 3 разных логических устройства на одном физическом. Для чего. Стандарт Zigbee не позволяет создавать кластеры с одинаковыми атрибутами на одном endpoint'е. А у нас два одинаковых счетчика с одинаковыми атрибутами CurrentSummationDelivered в кластере SeMetering. Поэтому в первом enpoint'е счетчик горячей воды, во втором - счетчик холодной.
