...
## TODO
- Сделать светодиодную индикацию режимов работы модуля.
- Сделать DEEP SLEEP, если модуль не в сети более 30 минут.
- Сделать сброс OTA, если обновление завершилось ошибкой, чтобы не зависеть от действий пользователя.
