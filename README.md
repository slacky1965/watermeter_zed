...
1. Светодиод с периодичностю от 5 секунд до 5 минут мограет одной вспышкой - модуль находится в сети, работает в штатном режиме.
...
- 1.3.01 - Изменена нумерация версий. Добавлены светодиодная индикация режимов модуля; глубокий сон, если не с сети более 30 минут; сброс OTA, если обновление прошло с ошибкой, обновление начнется с начала, сделано чтобы не потерять основной конфиг.
