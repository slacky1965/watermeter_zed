 ...
 * @note    when data protection, only enumeration items in mid134051_lock_block_e can be selected,
 *          to ensure that the values returned by the interface flash_get_lock_block_mid134051 are in the mid134051_lock_block_e.
 */
typedef enum{
